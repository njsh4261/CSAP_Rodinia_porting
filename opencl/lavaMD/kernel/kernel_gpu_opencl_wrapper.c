...
//======================================================================================================================================================150
//	MBAP libraries, functions and kernel running on CPU
//======================================================================================================================================================150
#include <thread>
#include <vector>
#include <atomic>
...
void kernel_gpu_opencl(	par_str d_par_gpu,
					dim_str d_dim_gpu,
							...
							int throttling_alloc)
{
	...
	// FIXME: modify following lines to change static or dynamic kernel
