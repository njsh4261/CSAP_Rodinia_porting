...
void OpenCL::launch(string toLaunch, size_t *global_work_size, size_t *local_work_size)
{
...
size_t OpenCL::createKernel(string kernelName)
{
...
void OpenCL::buildKernel()
{
	...
	ret = clBuildProgram(program, NULL, NULL, build_option, NULL, NULL);
